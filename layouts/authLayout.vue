...
<template>
  ...
  <div class="min-h-screen flex flex-col bg-white dark:bg-gray-900">
    ...
    <HNotification />
    <section
      class="flex justify-between bg-white dark:shadow-lg dark:shadow-gray-700/40 dark:bg-gray-900 md:shadow-lg shadow-lg lg:shadow-lg sm:shadow-lg xl:shadow-lg sticky top-0 overflow-hidden z-50 backdrop-blur-2xl"
    >
      <div
      ...
      >
        ...
        <div
          class="mt-2 flex-row md:flex-1 border dark:border-gray-700 border-gray-300 rounded-full w-1/2 md:mx-10 mb-2 items-center hidden md:flex bg-gray-50 hover:shadow-sm focus-within:shadow-md transition-shadow duration-200"
        >
          <input
            type="text"
            v-model="searchStore.searchQuery"
            placeholder="Search for recipes"
            class="rounded-full md:px-4 px-2 py-4 dark:bg-gray-900 dark:border-gray-700 md:flex-1 pl-4 bg-transparent text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-0"
          />
        </div>
      ...
      <nav class="md:flex md:flex-row mt-2 hidden items-center">
    ...
    <nav
      v-if="isMenuOpen"
      class="fixed top-0 right-0 bg-white z-50 h-screen w-1/2"
    >
