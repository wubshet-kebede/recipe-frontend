<script setup>
import get_recipe_of_user from "@/query/recipes/get_recipe_of_user.gql";
...
const recipes = ref([]);
const { onResult, loading, refetch, onError } = list(get_recipe_of_user, {
...
<template>
  <div
    class="flex flex-col gap-8 w-full mt-8 container mx-auto px-4 sm:px-6 lg:px-8 shadow-md dark:shadow-md dark:shadow-gray-400"
  >
    <div class="flex items-center justify-center mt-3">
      <h1 class="font-bold text-lg dark:text-secondary-lite">
        The recipe you created
      </h1>
    </div>
    <hr class="border-t-2 border-gray-300 dark:border-gray-500" />
    <div
